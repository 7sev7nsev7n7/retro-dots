...
hi('Conceal',               {ctermfg=15,ctermbg=8})
...
hi('StatusLineNC',          {ctermbg=16,ctermfg=15,cterm={dim=true}})
...
hi('Error',                 {ctermfg=0,ctermbg=1,cterm={bold=true}})
hi('Todo',                  {link='Title'})
...
hi('DiffText',      {ctermfg=16,ctermbg=11,cterm={bold=true}})
hi('DiffAdd',       {ctermbg=10,ctermfg=0})
hi('DiffChange',    {ctermbg=7,ctermfg=16,cterm={bold=true}})
